...
imgmap.prototype.img_mousedown = function(e) {
	...
	var pos = this._getPos(this.pic),
		x = Math.round(e.clientX - pos.x),
		y = Math.round(e.clientY - pos.y);
 ...
 */
imgmap.prototype.highlightArea = function(id) {
 ...
 *	@param	id	The id of the area to blur.
 */
imgmap.prototype.blurArea = function(id) {
	if (this.is_drawing) {return;}//exit if in drawing state
	var area = this.areas[id];
	if (area && area.shape != 'undefined') {
...
imgmap.prototype.area_mousemove = function(e) {
	if (!this.is_drawing) {
		...
		var xdiff = rect ? e.clientX - rect.left : window.event.offsetX;
		var ydiff = rect ? e.clientY - rect.top : window.event.offsetY;
